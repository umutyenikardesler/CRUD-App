...
export default function EditScreen() {
    ...
    useEffect(() => {
        ...
        const fetchData = async (id) => {
            try {
                ...
                const storeTodos = jsonValue != null ? JSON.parse(jsonValue) : null;

                if(storeTodos && storeTodos.length) {
                    const myTodo = storeTodos.find(todo => todo.id.toString() === id)
                    setTodo(myTodo)
                }
    ...
    const handleSave = async () => {
        try {
            ...
            if(storeTodos && storeTodos.length) {
                const otherTodos = storeTodos.filter(todo => todo.id !== savedTodo.id)
